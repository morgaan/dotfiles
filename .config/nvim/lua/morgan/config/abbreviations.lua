...
cmd('iabbr codeepali Co-authored-by: Deepali Dubey <deepali.dubey@springernature.com>')

cmd('iabbr coarun Co-authored-by: Arun Prasath <arunprasath.tamilselvan@springernature.com>')

cmd('iabbr cobruno Co-authored-by: Bruno Amorim <bruno.amorim@springernature.com>')
cmd('iabbr coluis Co-authored-by: Luis Silva <luis.silva@springernature.com>')
