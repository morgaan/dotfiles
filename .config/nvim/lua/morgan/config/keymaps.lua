...
keymap('n', '<C-h>', '<C-w>h', { desc = 'Easier window navigation toward left' })
keymap('n', '<C-j>', '<C-w>j', { desc = 'Easier window navigation toward down' })
keymap('n', '<C-k>', '<C-w>k', { desc = 'Easier window navigation toward up' })
keymap('n', '<C-l>', '<C-w>l', { desc = 'Easier window navigation toward right' })
